...
Offset = double(importdata('F:\Scripts\Thorlabs Matlab Files\OCT Calibration Files\Offset.dat'));
Chirp=importdata('F:\Scripts\Thorlabs Matlab Files\OCT Calibration Files\Chirp.dat');
electronScaling = 540;
